...
$projectIdForUser = isset($_GET['projectIdForUser']) ? $_GET['projectIdForUser'] : null;
...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="number"name="active" maxlength="1" required><br>

        <label for="actuel">actuel</label>
        <input type="number" name="actuel" required><br>
        ...
        <input type="number" name="MaxHours" required><br>
